...
(function() {
  ...
  const generateHomeButton = () =>{
    ...
    home.classList.add('exit-button');
  ...
  function createInfoHotspotElement(hotspot) {
    ...
    var modalSize = document.createElement('p');
    modalSize.innerHTML = hotspot.size;

    var modalBody = document.createElement('div');

    if (hotspot.paragraphs){
      for (var i = 0; i < hotspot.paragraphs.length; i++){
        var par = document.createElement('p');
        par.innerHTML = hotspot.paragraphs[i];
    ...
    modalContent.appendChild(modalSize);
    modalContent.appendChild(modalBody);

    if (hotspot.fossil){
      var citationWrapper = document.createElement('div');
      citationWrapper.classList.add('citation-wrapper')
      var fossil = document.createElement('img');
      fossil.classList.add('citation-image');
      ...
      link.href = hotspot.fossil.citationUrl;
