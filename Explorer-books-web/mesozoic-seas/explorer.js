(function () {
  ...
  function updateCopy() { var entry = scenes[activeIndex]; document.getElementById('scene-title').textContent = entry.title; document.getElementById('scene-description').textContent = entry.description; document.getElementById('scene-count').textContent = (activeIndex + 1) + ' of ' + scenes.length; }
